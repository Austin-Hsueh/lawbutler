...
//     "use strict";
//     $('#provisionModal #loginModal .registerBox').fadeOut('normal',function(){
...
if (/iphone|ipod|android|blackberry|mini|windows\sce|palm/i.test(navigator.userAgent.toLowerCase())) {
    ...
    $("h2.se2-mobile").html("今天起你將擁有<br>自己的法律管家");
    ...
    $("footer.footer.dark-bg").css("text-align","center !important");
